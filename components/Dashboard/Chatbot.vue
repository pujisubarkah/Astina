<template>
  <div class="chatbot-container">
    ...
    <div class="fixed bottom-6 right-6 z-[9999]">
      <button 
        @click="toggleChatbot" 
        class="btn btn-circle btn-primary btn-lg shadow-2xl hover:shadow-xl transition-all duration-300 animate-pulse"
        :class="{ 'btn-outline': isChatbotOpen }"
        title="ASTINA Assistant - Klik untuk chat"
      >
    ...
    <div 
      ...
      class="fixed bottom-24 right-6 w-96 h-96 bg-white rounded-lg shadow-2xl border border-gray-200 z-[9998] flex flex-col animate-fade-in"
    >
      <!-- Header -->
...
onMounted(() => {
  // Debug log to verify chatbot is mounted
  console.log('🤖 ASTINA Chatbot component mounted successfully!')
  ...
  // Show a temporary notification that chatbot is ready
  setTimeout(() => {
    console.log('💬 ASTINA Chatbot ready! Look for the blue chat button in bottom-right corner.')
  }, 1000)
})
...
/* Ensure chatbot window is always visible when open */
