    ...
    <div class="navbar-start">
      <div class="dropdown">
        ...
        <ul
          ...
          <li><a href="/dashboard" class="hover:bg-blue-50 hover:text-blue-600 transition-all duration-200 rounded-lg">Monitoring</a></li>
...
onMounted(() => {
  ...
  // Listen for global login modal events
  if (process.client) {
